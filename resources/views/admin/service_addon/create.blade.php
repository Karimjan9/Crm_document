...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card radius-10">
            <div class="card-body">
                <form action="{{ route('superadmin.addon.store',[$service_id]) }}" method="POST">
                    @csrf

                    <div class="mb-3">
                        <label for="filial_nomi">Service nomi</label>
                        <input type="text" id="filial_nomi" name="name" class="form-control" placeholder="Tarjima qilish" required>
                    </div>

                    <div class="mb-3">
                        <label for="filial_kodi">Service narxi</label>
                        <input type="number" id="filial_kodi" name="price" class="form-control" placeholder="000000" required>
                    </div>
                     <div class="mb-3">
