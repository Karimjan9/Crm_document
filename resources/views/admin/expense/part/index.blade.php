                ...
                <div class="card-body p-0">
                    <table class="table table-hover table-striped mb-0">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <button type="button"
                                                    class="btn btn-sm btn-outline-primary edit-expense-btn"
                                                    data-id="{{ $expense->id }}"
                                                    data-amount="{{ $expense->amount }}"
                                                    data-filial="{{ $expense->filial->name ?? '' }}"
                                                    data-description="{{ $expense->description }}">
                                                Tahrirlash
                                            </button>
                                            <form method="POST" action="{{ route('admin_filial.expense_admin.destroy', $expense) }}" onsubmit="return confirm('Xarajatni o‘chirishni tasdiqlaysizmi?');">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-3">Xarajatlar mavjud emas</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
<div class="modal fade" id="addExpenseModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('admin_filial.expense_admin.store') }}" method="POST" enctype="multipart/form-data" id="addExpenseForm">
            @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="edit_filial" class="form-control" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Izoh:</label>
