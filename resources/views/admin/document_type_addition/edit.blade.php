...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card radius-10">
            <div class="card-body">
                <form action="{{ route('superadmin.type_addition.update',['document_type'=>$id,'type_addition'=>$documentType->id]) }}" method="POST">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-custom">O'zgartirish</button>
