...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card radius-10">
            <div class="card-body">
                <form action="{{ route('superadmin.direction_addition.store',['direction_type'=>$id]) }}" method="POST">
                    @csrf
                    <input type="hidden" name="direction_type" value="{{$id}}">
                    <div class="mb-3">
                        <label for="filial_nomi">Hujjat turi qo'shimchasi nomi</label>
                        <input type="text" id="filial_nomi" name="name" class="form-control" placeholder="Hujjat turi qo'shimchasi" required>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <a href="{{ route('superadmin.direction_addition.index',['direction_type'=>$id]) }}" class="btn btn-outline">Bekor qilish</a>
                    </div>
                </form>
            </div>
        </div>
