...
<div class="page-wrapper">
    <div class="page-content">
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <button class="btn btn-primary">+ Yangi hujjat</button>
        </div>
        ...
        <!-- 👤 Foydalanuvchilar bo‘yicha jadval -->
        <div class="card mb-4">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Foydalanuvchi</th>
                            <th>Filial</th>
                            <th>Yuklagan hujjatlar</th>
                            <th>Tasdiqlangan</th>
                            <th>Faoliyat foizi</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <!-- 📄 Hujjat turlari bo‘yicha jadval -->
        <div class="card mb-4">
