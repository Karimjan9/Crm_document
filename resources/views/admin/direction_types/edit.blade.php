...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card radius-10">
            <div class="card-body">
                <form action="{{ route('superadmin.direction_type.update',['direction_type'=>$directionType->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="description">Hujjat yo'nalish izoh</label>
                        <textarea id="description" name="description" rows="4" class="form-control" placeholder="Filial haqida qisqacha ma’lumot...">{{ $directionType->description }}</textarea>
                    </div>
